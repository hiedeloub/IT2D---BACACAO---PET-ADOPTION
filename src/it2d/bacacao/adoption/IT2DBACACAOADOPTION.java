...
public class IT2DBACACAOADOPTION {
    ...
    public static void main(String[] args) {
      ...
      private void viewpet() {
        ...
        String qry = "SELECT * FROM tbl_PetAdoption";
        String[] hrds = {"ID" ,"Pet Name", "Pet Species", "Pet Breed", "Pet Status"};
        String[] clm = {"p_id", "p_name", "p_species", "p_breed", "p_status"};
    ...
    private void updatepet(){
        ...
        String qry = "UPDATE tbl_PetAdoption SET p_name = ?, p_species = ?, p_breed = ?, p_status = ? WHERE p_id = ?";
      ...
      private void deletepet() {
          ...
          String qry = "DELETE FROM tbl_PetAdoption WHERE p_id = ?";
